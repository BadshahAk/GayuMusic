...
from GayuMusic import LOGGER, Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from GayuMusic.core.call import Gayu
from GayuMusic.utils import seconds_to_min, time_to_seconds
from GayuMusic.utils.channelplay import get_channeplayCB
from GayuMusic.utils.database import add_served_chat, get_assistant, is_video_allowed
from GayuMusic.utils.decorators.language import languageCB
from GayuMusic.utils.decorators.play import PlayWrapper
from GayuMusic.utils.formatters import formats
from GayuMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from GayuMusic.utils.inline.playlist import botplaylist_markup
from GayuMusic.utils.logger import play_logs
from GayuMusic.utils.stream.stream import stream
...
@app.on_callback_query(filters.regex("GayuPlaylists") & ~BANNED_USERS)
@languageCB
