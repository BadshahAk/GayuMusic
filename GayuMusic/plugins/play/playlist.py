...
from GayuMusic import Carbon, app
from GayuMusic.utils.decorators.language import language, languageCB
from GayuMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from GayuMusic.core.mongo import mongodb
...
@app.on_callback_query(filters.regex("Gayu_playlist") & ~BANNED_USERS)
@languageCB
