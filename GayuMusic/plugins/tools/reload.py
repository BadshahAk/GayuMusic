...
from GayuMusic.utils.database import get_authuser_names, get_cmode
from GayuMusic.utils.decorators import ActualAdminCB, AdminActual, language
from GayuMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Gayu.stop_stream(message.chat.id)
    except:
        pass
